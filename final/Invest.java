...
public class Invest extends Tile {
    ...
    public void printMenu() {
        ...
        System.out.println("1. Евел Ко, мин. инв. - 500 кф. -0.2, рисков интервал - (-5/+100)");
        System.out.println("2. Бомбс Ауей,мин.инв - 400, кф. - 0.5, рисков интервал - (-10/+50)");
        System.out.println("3. Мародерс Юнитед,мин.инв - 200, кф. - 2, рисков интервал - (-18/+50)");
        System.out.println("4. Клок Уорк ,мин.инв - 300, кф. - 0.5, рисков интервал - (-15/+35)");
        System.out.println("5. Фаткат, мин.инв - 100, кф. - 2.5, рисков интервал - (-25/+100)");
        System.out.println("6. Макрософт,мин.инв - 50, кф. - 5.0, рисков интервал - (-20/+10)");
    ...
    public void bombsAwayl(Player player) {
        ...
        public void stealBonus(int index, Player player) {
            ...
            if(player.isStealBonusActive() && index == 2) {
